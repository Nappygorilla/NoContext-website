(() => {
  ...
  const initProductPreview = () => {
    ...
    style.textContent = `
      ...
      .luna-preview-mark{display:grid;place-items:center;width:25px;height:25px;border:1px solid rgba(170,190,255,.45);border-radius:7px;color:#dfe7ff;font-size:.55rem}
      .luna-preview-status{color:#dfe7ff}.luna-preview-status i{display:inline-block;width:6px;height:6px;margin-right:6px;border-radius:50%;background:#dfe7ff;box-shadow:0 0 12px rgba(170,190,255,.45)}.luna-preview-status span{margin-left:8px;color:#59615e}
      ...
      .luna-preview-tab:hover{color:#e7ece9;background:rgba(255,255,255,.035)}.luna-preview-tab.active{color:#dfe7ff;background:rgba(170,190,255,.065);border-color:rgba(170,190,255,.12)}
      ...
      .luna-toggle{position:relative;width:38px;height:22px;flex:0 0 auto;border:1px solid #343b38;border-radius:999px;background:#151918;cursor:pointer;transition:.2s}.luna-toggle span{position:absolute;top:3px;left:3px;width:14px;height:14px;border-radius:50%;background:#6a736f;transition:.2s}.luna-toggle.active{border-color:rgba(170,190,255,.35);background:rgba(170,190,255,.12)}.luna-toggle.active span{left:19px;background:#dfe7ff;box-shadow:0 0 12px rgba(170,190,255,.35)}
